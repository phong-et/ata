                              ...
                              child: Row(
                                ...
                                children: <Widget>[
                                  Column(
                                    children: <Widget>[
                                      Row(children: [
                                        Text('Date', style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.bold, fontSize: 12.0)),
                                      ]),
                                      SizedBox(
                                        height: 5,
                                      ),
                                      Row(children: [
                                        Text(rangeDates, style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.bold, fontSize: 12.0)),
                                      ])
                                    ],
                                  ),
                                  Column(
                                    children: <Widget>[
                                      Row(children: [
                                        Text('In Time', style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.bold, fontSize: 12.0)),
                                      ]),
                                      SizedBox(
                                        height: 5,
                                      ),
                                      Row(children: [
                                        Text(inTime, style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.bold, fontSize: 12.0)),
                                      ])
                                    ],
                                  ),
                                  Column(
                                    children: <Widget>[
                                      Row(children: [
                                        Text('Out Time', style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.bold, fontSize: 12.0)),
                                      ]),
                                      SizedBox(
                                        height: 5,
                                      ),
                                      Row(children: [
                                        Text(outTime == null ? 'Forgot' : outTime,
                                  ...
                                  Column(
                                    children: <Widget>[
                                      Row(children: [
                                        Text('Total Hours', style: TextStyle(color: Colors.grey[600], fontWeight: FontWeight.bold, fontSize: 12.0)),
                                      ]),
